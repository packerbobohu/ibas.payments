...
export class PaymentListView extends ibas.BOListView implements IPaymentListView {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.Payment>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.Payment>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.Payment[] {
        return utils.getTableSelecteds<bo.Payment>(this.table);
    }
}
